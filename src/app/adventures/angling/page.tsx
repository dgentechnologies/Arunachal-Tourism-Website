  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center text-center px-4">
      <div className="max-w-md">
        ...
        <h1 className="text-3xl font-bold font-headline mb-3">Angling</h1>
        <p className="text-muted-foreground mb-6">
          Arunachal&apos;s pristine rivers — Siang, Subansiri, Kameng — are among the
          world&apos;s finest for mahseer and golden mahseer angling. Permits required.
        </p>
