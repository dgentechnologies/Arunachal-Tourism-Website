  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center text-center px-4">
      <div className="max-w-md">
        ...
        <h1 className="text-3xl font-bold font-headline mb-3">River Rafting</h1>
        <p className="text-muted-foreground mb-6">
          The Siang River offers some of India&apos;s most challenging white-water
          rafting. Grade IV–V rapids, October–April season, experienced operators.
        </p>
