...
import { Gauge, ShieldCheck, Map, MapPin, ArrowRight, Car, Bike, Bus, Truck, Search, Phone, Star } from "lucide-react"
...
export default function TransportPage() {
  ...
  useEffect(() => { setSourceSuggestions(getSuggestions(source)) }, [source])
  useEffect(() => { setDestSuggestions(getSuggestions(destination)) }, [destination])
